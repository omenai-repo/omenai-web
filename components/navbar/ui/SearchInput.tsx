...
export default function SearchInput() {
  ...
  return (
    <div className="relative flex w-full justify-between gap-x-5 items-center rounded-sm border bg-transparent border-dark/30">
      <input
        type="text"
        className="w-full h-[35px] bg-transparent px-3 border-none rounded-sm placeholder:text-xs placeholder:font-normal focus:border-none focus:ring-0 focus:border-0"
