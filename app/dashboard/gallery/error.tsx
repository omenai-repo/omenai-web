    ...
    <div className="w-full h-[85vh] grid place-items-center">
      <div className="w-full h-full flex flex-col items-center justify-center">
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <button
            className="h-[50px] text-[14px] font-normal w-fit disabled:cursor-not-allowed disabled:bg-gray-400 disabled:text-[#A1A1A1] px-4 bg-black text-white cursor-pointer mt-5 grid place-items-center"
            onClick={
