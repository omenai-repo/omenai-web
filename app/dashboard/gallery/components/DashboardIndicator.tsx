    ...
    <div className="w-full flex justify-between items-center">
      ...
      {!gallery_verified ? (
        <div className="" id="gallery-verification">
          <button className=" w-full text-xs disabled:cursor-not-allowed whitespace-nowrap disabled:bg-[#E0E0E0] bg-dark rounded-sm text-white h-[35px] px-4 flex gap-x-2 items-center justify-center hover:bg-dark/80">
