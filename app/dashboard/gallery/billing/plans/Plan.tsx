              ...
              <div className="flex flex-1 flex-col justify-between rounded-2xl bg-gray-50 p-4">
                ...
                <div className="mt-8">
                  <Link
                    ...
                    className="h-[35px] px-4 w-full text-[14px] text-white disabled:cursor-not-allowed disabled:bg-[#E0E0E0] hover:bg-dark/80 bg-dark duration-300 grid place-items-center"
