...
export default function SubscriptionStatus({
  ...
  return (
    <div className="w-full px-5 mt-8">
      ...
      <div className="mt-6">
        {sub_status === "canceled" ? (
          <button className=" h-[50px] px-4 rounded-md w-fit bg-dark text-white hover:bg-dark/70 flex gap-2 items-center">
            Reactivate Subscription
          </button>
        ) : (
          <button
            className=" h-[50px] px-4 rounded-md w-fit bg-red-600 flex gap-2 items-center"
