      ...
      <div className="w-full h-[85vh] grid place-items-center">
        <div className="p-6 grid place-items-center text-center space-y-4">
          ...
          <div className="flex space-x-2 items-center">
            <Link
              href="/"
              className="flex items-center whitespace-nowrap justify-center space-x-2 h-[50px] px-4 w-full bg-black text-white cursor-pointer mt-[50px] transition duration-150"
              title="Return Home"
            >
              <svg
