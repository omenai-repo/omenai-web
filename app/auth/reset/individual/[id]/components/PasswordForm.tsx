      ...
      <form className="flex flex-col gap-8" onSubmit={handleSubmit}>
        <div className="flex flex-col gap-2">
          ...
          <input
            ...
            required
            className="ring-1 ring-black focus:ring-primary ease-linear duration-150 transition-all  h-[35px] px-4 rounded-sm text-xs italic placeholder:text-gray-400"
          />
        </div>
        <div className="flex flex-col gap-2">
        ...
        <div className="self-end">
          <button
            disabled={isLoading}
            className="grid disabled:cursor-not-allowed disabled:bg-dark/20 place-items-center rounded-md bg-dark h-[35px] px-4 text-white hover:bg-dark/90"
          >
